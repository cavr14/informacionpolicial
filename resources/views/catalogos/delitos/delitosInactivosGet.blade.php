                ...
                @foreach($delitos as $delito)
                    <tr>
                        ...
                        <td class="text-center">
                            <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#activateModal{{$delito->idDelito}}">Activar</button>
                            <!-- Modal -->
                            <div class="modal fade" id="activateModal{{$delito->idDelito}}" tabindex="-1" aria-labelledby="activateModalLabel{{$delito->idDelito}}" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="activateModalLabel{{$delito->idDelito}}">Confirmar Activación</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            ¿Estás seguro de que deseas activar este delito?
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                                            <a href="{{ url("/catalogos/delitos/{$delito->idDelito}/activar") }}" class="btn btn-primary">Activar</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
